...
void							init_coder(t_coder *any, t_pars *parsing,
									int id);
int								init_dongle(t_dongle *dongle, t_pars *parsing,
									int size, int id);
int								init_table(t_coder *coders, t_pars *parsing,
									t_dongle *dongles, int size);
void							init_monitor(t_info_monitor *monitor,
...
int								check_burnout(int i, int k, long res,
									t_info_monitor *info);
...
void							init_character(t_character *bunch,
									t_coder *coders, t_simulation *state,
									t_dongle *dongles);
